...
public class DisasterWarningController extends BaseController {
    ...
    public TableDataInfo<WarningProgressFeedbackVO> queryWarningProgressFeedbackList(@RequestParam("disasterWarningId") Integer disasterWarningId,
                                                                                     @RequestParam(value = "parentUserId", required = false) String parentUserId,
                                                                                     PageQuery pageQuery) {
        return iWarningProgressFeedbackService.queryWarningProgressFeedbackList(disasterWarningId, parentUserId, pageQuery);
    }
